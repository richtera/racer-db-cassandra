  ...
  for (var i in schema.info.fields) {
    ...
    if (!field.solr_type) {
      ...
      case 'blob':
        ...
        break;
      case 'uuid':
        field.solr_type = 'uuid';
//        field.solr_exclude = true;
        break;
      case 'timestamp':
        field.solr_type = 'date';
//        field.solr_exclude = true;
        break;                
      case 'boolean':
        field.solr_type = 'boolean';
//        field.solr_exclude = true;
        break;
      case 'date':
        field.solr_type = 'date';
//        field.solr_exclude = true;
        break;
      case 'float':
        field.solr_type = 'float';
//        field.solr_exclude = true;
        break;
      case 'double':
        field.solr_type = 'double';
//        field.solr_exclude = true;
        break;
      case 'int':
        field.solr_type = 'int';
//        field.solr_exclude = true;
  ...
  for (var i in schema.info.fields) {
    if (/^_.*/.test(i) || /\./.test(i))
      continue;
    var field = schema.info.fields[i];
    var type = field.solr_type || "string";
