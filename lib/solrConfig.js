...
exports.solrSchema = function (schema) {
  ...
  var firstDefaultField = null;
  for (var i in schema.info.fields) {
    if (/^_.*/.test(i))
      continue;
    var type = "text";
    var name = i;
    if (schema.info.fields[i].solrDefault)
      defaultField = i;
    if ((!firstDefaultField && i !== 'id') || (i.indexOf('name') != -1 && firstDefaultField.indexOf('name') == -1))
      firstDefaultField = i;
    output.push(
  ...
  if (!defaultField)
    defaultField = firstDefaultField;
  if (!defaultField)
    return null;
  output.push(
    '  </fields>'
