...
exports.solrSchema = function (schema) {
  var output = [
    ...
    '  </types>',
    '  <fields>',
    '    <field name="_core" type="string" indexed="false" stored="true" multiValued="true"/>',
    '    <field name="_body_partial" type="text_partial" indexed="true" stored="false" multiValued="true"/>',
    '    <field name="_body" type="text" indexed="true" stored="false" multiValued="true"/>',
