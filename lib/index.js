...
Cassandra.prototype.connect = function connect (options, callback) {
  ...
  var login = {host:info.hostname, log:options.log, logging: options.logging, cqlVersion : '3.0.0', port:info.port || 9160, keyspace:keyspace, user:options.user, pass:options.password};
...
Cassandra.prototype.indexDoc = function indexDoc(collection, doc) {
  var o = Object.create(doc);
